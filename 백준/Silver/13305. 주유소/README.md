...
### 접근 방법
- 맨 왼쪽 도시부터 차례대로 시작 도시, 그 다음 도시의 연료 가격을 비교한 뒤 아래와 같은 절차로 구했다.
  - 만일 가격이 시작 도시 > 그 다음 도시라면
    - 해당 도시까지 갈 수 있는 만큼의 연료만 시작 도시에서 주유
    - 이후 해당 도시로 이동
  - 시작 도시 < 그 다음 도시라면
    - 또 그 이후 도시의 가격을 검사하며 비교
